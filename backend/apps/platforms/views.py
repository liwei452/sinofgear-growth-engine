...
from .serializers import PlatformListSerializer, PlatformSerializer, SocialAccountListSerializer, SocialAccountSerializer
...
class SocialAccountListView(APIView):
    ...
    @extend_schema(request=SocialAccountSerializer, responses={201: SocialAccountSerializer})

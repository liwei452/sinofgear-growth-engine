...
CELERY_BEAT_SCHEDULE = {
    "dispatch-due-ai-retries": {
        "task": "apps.ai.tasks.dispatch_due_ai_retries",
        "schedule": 30.0,
    }
}
...
AI_CREDENTIAL_STORE = os.environ.get("AI_CREDENTIAL_STORE", "windows").lower()
AI_CREDENTIAL_STORE_TEST_FAKE_ALLOWED = False
DEEPSEEK_API_BASE_URL = "https://api.deepseek.com"
DEEPSEEK_MAX_RESPONSE_BYTES = 1_000_000
DEEPSEEK_MAX_JSON_DEPTH = 64

...
EMAIL_VERIFICATION_DNS_TIMEOUT_SECONDS = float(
    os.environ.get("EMAIL_VERIFICATION_DNS_TIMEOUT_SECONDS", "3")
)
EMAIL_VERIFICATION_DNS_LIFETIME_SECONDS = float(
    os.environ.get("EMAIL_VERIFICATION_DNS_LIFETIME_SECONDS", "5")
)
EMAIL_VERIFICATION_SMTP_TIMEOUT_SECONDS = float(
    os.environ.get("EMAIL_VERIFICATION_SMTP_TIMEOUT_SECONDS", "5")
)
EMAIL_VERIFICATION_SMTP_RETRIES = int(
    os.environ.get("EMAIL_VERIFICATION_SMTP_RETRIES", "1")
)
EMAIL_VERIFICATION_DOMAIN_LOCK_SECONDS = int(
    os.environ.get("EMAIL_VERIFICATION_DOMAIN_LOCK_SECONDS", "10")
)
EMAIL_VERIFICATION_CLAIM_TIMEOUT_SECONDS = int(
    os.environ.get("EMAIL_VERIFICATION_CLAIM_TIMEOUT_SECONDS", "120")
)
...
CELERY_BEAT_SCHEDULE = {
    ...
    "publishing-sync-post-metrics-hourly": {
        "task": "apps.publishing.tasks.sync_post_metrics_hourly",
        "schedule": 3600.0,
    },
    "publishing-reap-stale-minute": {
        "task": "apps.publishing.tasks.reap_stale_publish_tasks_task",
        "schedule": 60.0,
    },
}

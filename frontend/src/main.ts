...
const router = createAppRouter(queryClient, {
  components: {
    ...
    AISettings: defineAsyncComponent(() => import("./modules/aiSettings/DeepSeekSettingsPage.vue")),
    AgentCenter: defineAsyncComponent(() => import("./modules/director/AgentCenterPage.vue")),
  },
})

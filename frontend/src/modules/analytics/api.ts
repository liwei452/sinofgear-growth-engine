...
export const getChannelSummary=async(filters:Record<string,string|undefined>,options:Pick<ApiRequestOptions,"signal">={}):Promise<Summary>=>required(await apiRequest(query("/api/v1/analytics/channel-summary",filters),options))

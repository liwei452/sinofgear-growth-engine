...
<style scoped>
.review-center{display:grid;gap:1.4rem}.tabs{display:flex;gap:.5rem;border-bottom:1px solid var(--sg-line)}.tabs button{padding:.75rem 1rem;border:0;border-bottom:3px solid transparent;background:transparent}.tabs button[aria-selected=true]{border-color:var(--sg-brand);color:var(--sg-brand);font-weight:800}.filters,.card-heading{display:flex;gap:1rem;justify-content:space-between;align-items:flex-start}.filters{flex-wrap:wrap;padding:1rem;border-radius:1rem;background:var(--sg-canvas)}.filters label{display:grid;gap:.35rem}.review-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1rem}.review-card{padding:1rem;border:1px solid var(--sg-line);border-radius:1rem;background:var(--sg-surface)}.status-chip{padding:.25rem .55rem;border-radius:999px;background:var(--sg-brand-tint);color:var(--sg-brand);font-weight:700}.muted{color:var(--sg-muted)}.notice{padding:.75rem 1rem;border-radius:.75rem;background:var(--sg-status-success-tint);color:var(--sg-status-success)}@media(max-width:600px){.filters,.card-heading{display:grid}.filters label{width:100%}}
.tabs button[aria-selected=true]{border-bottom-color:var(--sg-brand)}
</style>

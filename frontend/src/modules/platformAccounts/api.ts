...
export type SocialAccount={id:string;platform_id:string;display_name:string;publish_mode:"MANUAL"|"API_AUTO";status:"ACTIVE"|"INACTIVE";effective_capabilities:string[];credential_configured:boolean}

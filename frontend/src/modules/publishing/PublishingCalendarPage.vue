...
function actionPending(id:string,kind:"cancel"|"retry"){return pendingActions.value.has(actionKey(id,kind))}
async function runAction(id:string,kind:"cancel"|"retry"){

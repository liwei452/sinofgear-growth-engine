...
.work-item-card[data-priority="URGENT"] { border-color: #efc5bf; background: #fff9f8; }
.work-item-card[data-priority="HIGH"] { border-color: #efd6b8; background: #fffaf3; }
...
.draft { margin: 0; border-radius: 7px; background: #eef7ff; padding: 9px 11px; color: var(--sg-ink); font-size: .78rem; line-height: 1.5; }
